        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-popconfirm confirm-button-text="确定" cancel-button-text="取消"
                           icon-color="#626AEF" :title="'确定删除班级名为“'+scope.row.name+'”的班级吗？'"
...
import {deleteGradeClassApi, getGradeClassApi, getGradeClassListApi} from "../../api/gradeclass/gradeclass"
