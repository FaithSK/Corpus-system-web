<template>
  <el-form ref="ruleFormRef" :rules="rules"  :model="formStudent"  label-width="80px">
    <el-row>
      <el-col :span="12">
        <el-form-item prop="gradeClass" label="所属课程">
          <el-select v-model="formStudent.gradeClass.id" placeholder="请选择课程" style="width: 100%;">
      ...
      <el-col :span="12">
        <el-form-item label="释义" prop="translate">
          <el-input v-model="formStudent.sex" placeholder="请输入单词释义" />
        </el-form-item>
      </el-col>
<!--      <el-col :span="12">-->
...
<!--      </el-col>-->
  ...
  <div class="dialong__button--wrap">
    ...
    <el-button color="#178557" :loading="subLoading" type="success" @click="addStudent(ruleFormRef)">保存</el-button>
  </div>
</template>
