  ...
  <el-card class="box-card">
    ...
    <template #header>
      <div class="card-header">
        <h3>
          <el-icon style="margin-right: 10px;"><UserFilled /></el-icon>课程管理
        </h3>
        ...
        <div class="card-search">
          <el-row :gutter="10">
            ...
            <el-col :span="11">
              <div class="my-button">
              <el-button plain style="width: 100%;" color="#2fa7b9" @click="addCourse">添加数据</el-button>
        ...
        <el-table-column label="操作">
          <template #default="scope">
            ...
            <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" :icon="Delete"
                           icon-color="#626AEF" :title="'确定删除课程名为“'+scope.row.coursename+'”的课程吗？'"
